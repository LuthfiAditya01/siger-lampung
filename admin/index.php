...
<body class="bg-gray-100">
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside id="sidebar" class="fixed lg:static w-[280px] min-h-screen bg-white shadow-lg transition-all duration-300 ease-in-out z-30">
            <div class="p-4 h-full flex flex-col">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        <img src="../img/logo.png" alt="Logo" class="h-8 w-auto mr-2">
                        <span class="text-xl font-semibold">Siger Lampung</span>
                    </div>
                </div>
                ...
                <!-- Logout Button -->
                <div class="mt-auto">
                    <a href="?logout" class="flex items-center p-3 text-red-600 hover:bg-red-50 rounded-lg transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
